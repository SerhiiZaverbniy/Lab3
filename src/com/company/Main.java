...
public class Main {
    ...
    public static void main(String[] args){
        ...
        int i = 0;
        System.out.println("Вітаємо вас у грі 'Битва дроїдів'!");
        ...
        while (i != -1) {
            ...
            if(command.equals("/info")) {
                char c;
                System.out.println("А тепер виберіть дроїда про якого хочете знати. Серед варіантів є: \nДроїд(1), РПГ-дроїд(2), Снайпер(3), Щитоносець(4), Медик(5) і Підривник(6). \nДля детальної інформації введіть номер класу, або 0 щоб пропустити.");
                while ((c = reader.next().charAt(0)) != '0') {
                    String info = "";
                    Droid Y=new Droid();
                    if (c == '1') {
                        info = "Просто дроїд. Простий ванільний клас бойових дроїдів. \nВитривалість 125, максимальний дамаг 30. Здатен відновлювати свою виносливість.\n";
                        Y=new Droid();
                    }
                    if (c == '2'){
                        info = "РПГ-Дроїд. Витривалість рівна 50, а наносить 150 урона. \nНа жаль, цей робот працює як мавпа з гранатою, тому шанс того, що він виживе після свого ходу дуже малий\n";
                        Y=new Monkey();
                    }
                    if (c == '3'){
                        info = "Снайпер. Дроїд з покращеним прицілом, але з погіршеною пересувною здатністю.\nЗараз, час вшанувати хвилиною пам'яті усіх снайперів,\nякі готувалися до вистрілу по мішені, але самі стали мішенями для ворожих снайперів...\nХвилина закінчилась, продовжуєм.\nЦей дроїд може ослабити ворога, або повністю убити його. Дамаг 50, Витривалість 150\n";
                        Y=new Sniper();
                    }
                    if (c == '4'){
                        info = "Щитоносець. Ось цей дроїд найсміливіший серед усіх інших.\nВін здатен узяти усю лють ворога на себе і не дати їй задіти важливих дроїдів. \nНе хвилюйтеся, ви ще можете врятувати його від такої безглуздої смерті, просто замінюйте його пластини.\nКількість витривалості 300\n";
                        Y=new Shield();
                    }
                    if (c == '5'){
                        info = "Медик. А це незамінний дроїд для поля битви. Саме він допомагає дроїдам прожити ще довше на полі бою. \nСаме він ремонтує усі неполадки, перестановлює віндовс та змащує деталі. \nМожливо, його варто було назвати Інженер, але хто я такий, щоби сперечатися с креативним директором.\nВитривалість 150\n";
                        Y=new Medic();
                    }
                    if (c == '6'){
                        info = "Підривник.\nЦей гарячий молодий дроїд, не просто запалює седця жінок та деяких чоловіків, а ще й розриває їх на шматки. \nВ обоймі 5 набоїв дамагом близько 30 одиниць кожен, мало що витримає таку вибухову силу. Витривалість 200\n";
                        Y=new Bomber();
                    }
                    else {
                    ...
                    System.out.println("Дроїд - 1, Броньована машина - 2");
                    System.out.println("Снайпер - 3, Щитоносець - 4");
                    System.out.println("Медик - 5, Підривник - 6");
                }
            }
            else
            if(command.equals("/create")){
                boolean  j=true;
                System.out.println("Запускаємо створення вашого персонажа");
                while(j) {
                    list[i] = Create();
                    i++;
                    System.out.println("Персонажа було створено");
    ...
    public static void One(Droid Hero, Droid Evil, String Name1, String Name2,boolean comp){
        ...
        while(Hero.hp*Evil.hp!=0){
            ...
            Evil.EndOfMove();
            j++;
            System.out.println("Витривалість дроїда "+Hero.Name+ " рівна "+Hero.hp);
            System.out.println("Витривалість дроїда "+Evil.Name+ " рівна "+Evil.hp);
            Stop();
        }
    ...
    public static void Team(Droid[] Hero,Droid[] Evil,String Name1,String Name2,boolean comp){
        ...
        while(SumHp(Hero,5)*SumHp(Evil,5)!=0){
            ...
            for(int i=0;i<5;i++){
                System.out.println("Витривалість дроїда "+Hero[i].Name+ " рівна "+Hero[i].hp);
            }
            System.out.println(" ");
            for(int i=0;i<5;i++){
                System.out.println("Витривалість дроїда "+Evil[i].Name+ " рівна "+Evil[i].hp);
            }
        }
        System.out.println("Битва завершена");
