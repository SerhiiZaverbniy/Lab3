...
public class Medic extends Droid{
    ...
    public void Info() {
        ...
        System.out.println("Дія 2: відновлює витривалість союзнику, та збільшує її вище максимальної на цей та наступний ходи");
        System.out.println("Дія 3: відновлює усім живим союзникам трохи витривалості");
    }
    ...
    public void Message2(String X,int x){
        System.out.println("Відновив дроїду:"+X+ " витривалість до рівня "+x);
    }
}